...
public class SingleLinkedList {
	...
	/**
	 * Constructor
	 * Set the start of the list to be null 
	 * and counter to 0 as there is nothing yet in this list
	 */
	 ...
	 * Based on finding the first occurance of the data passed in
	...
	public void sort() {
        ...
        if(head == null) {  
            ...
            while(current != null) {  
                ...
                while(index != null) {  
                	//If the node that we are currently visting and that nodes data value is greater 
